  ...
  try {
    ...
    const newEvent = await userRef
      ...
      .set({
        image:
          image ||
          'https://images.unsplash.com/photo-1496843916299-590492c751f4?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=3451&q=80',
        name,
        location: location,
        id: autoGeneratedId,
        startTime: startTime,
    ...
    const emailList = attendees.map((guest) => ({
      ...
      dynamic_template_data: {
        ...
        end_time: endTime,
        confirmation_url: `https://gallant-noyce-b641f8.netlify.app/invite-reply?id=${uid}&event=${autoGeneratedId}&token=${guest.token}`,
      },
    }));
